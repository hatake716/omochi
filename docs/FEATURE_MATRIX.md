...
- **Device verified** — visibly exercised on a Pixel 10a (Android 17) on 2026-08-30.
...
| x86_64 / 32-bit Android | Excluded in v0.2 | No matching embedded PRoot binaries |

## v0.2 device evidence
...
4. Rotation, split-screen, keyboard attach/detach, long background intervals, and forced low-memory recreation.
5. Large repositories, long-running tasks, and project-specific debuggers/toolchains.
